...
{
    [Authorize]
    public class BankInsController : Controller
    {
        ...
        {
            ViewBag.Resi = "";
            return View("../Bank/BankIns/Index");
        }
        ...
        public ActionResult Create()
        {
            ...
            using (DbContextTransaction dbTran = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    bankTransaction.TransactionType = EnumBankTransactionType.In;
        ...
        public ActionResult Edit(int? id)
        {
            ...
            if (bankTransaction.IsPrint)
            {
                ...
                return View("../Bank/BankIns/EditVerification", verificationHistory);
            }
            else
            {
                ApplicationUser user = db.Users.Find(User.Identity.GetUserId<int>());
        ...
        public ActionResult Print(int? id)
        {
            ...
            if (obj.IsPrint)
            {
                ...
                return View("../Bank/BankIns/Print", verificationHistory);
            }
            else
            {
        ...
        public ActionResult GetVerificationCode(int? id)
        {
            ...
            return PartialView("../Bank/BankIns/_VerificationCode");
        }
        ...
        {
            return PartialView("../Bank/BankIns/_DetailsGrid", db.BankTransactionsDetails
        ...
        public ActionResult DetailsCreate(int? bankTransactionId)
        {
            ...
            return PartialView("../Bank/BankIns/_DetailsCreate", bankTransactioneDetails);
        }
        ...
        public ActionResult DetailsCreate([Bind(Include = "Id,BankTransactionId,Type,MasterBankId,ChartOfAccountId,Total,Notes,Created,Updated,UserId")] BankTransactionDetails bankTransactionDetails)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (DbContextTransaction dbTran = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        db.SystemLogs.Add(new SystemLog { Date = DateTime.Now, MenuType = EnumMenuType.BankInsDetails, MenuId = bankTransactionDetails.Id, MenuCode = bankTransactionDetails.ChartOfAccountId.ToString(), Actions = EnumActions.CREATE, UserId = User.Identity.GetUserId<int>() });
                        db.SaveChanges();
            ...
            return PartialView("../Bank/BankIns/_DetailsCreate", bankTransactionDetails);
        }
        ...
        public ActionResult DetailsEdit(int? id)
        {
            ...
            return PartialView("../Bank/BankIns/_DetailsEdit", obj);
        }
        ...
        public ActionResult DetailsEdit([Bind(Include = "Id,BankTransactionId,Type,MasterBankId,ChartOfAccountId,Total,Notes,Created,Updated,UserId")] BankTransactionDetails bankTransactionDetails)
        {
            ...
            return PartialView("../Bank/BankIns/_DetailsEdit", bankTransactionDetails);
        }
        ...
        {
            return PartialView("../Bank/BankIns/_DetailsHeaderGrid", db.BankTransactionsDetailsHeader
                .Where(x => x.BankTransactionId == Id).ToList());
        }
        ...
        public ActionResult DetailsHeaderCreate(int? bankTransactionId)
        {
            ...
            return PartialView("../Bank/BankIns/_DetailsHeaderCreate", bankTransactioneDetailsHeader);
        }
        ...
        public ActionResult DetailsHeaderCreate([Bind(Include = "Id,BankTransactionId,Type,GiroChequeId,MasterBankId,Total,Notes,Created,Updated,UserId")] BankTransactionDetailsHeader bankTransactionDetailsHeader)
        {
            ...
            return PartialView("../Bank/BankIns/_DetailsCreate", bankTransactionDetailsHeader);
        }
        ...
        public ActionResult DetailsHeaderEdit(int? id)
        {
            ...
            return PartialView("../Bank/BankIns/_DetailsHeaderEdit", obj);
        }
        ...
        public ActionResult DetailsHeaderEdit([Bind(Include = "Id,BankTransactionId,Type,MasterBankId,GiroChequeId,Total,Notes,Created,Updated,UserId")] BankTransactionDetailsHeader bankTransactionDetailsHeader)
        {
            ...
            return PartialView("../Bank/BankIns/_DetailsEdit", bankTransactionDetailsHeader);
        }
