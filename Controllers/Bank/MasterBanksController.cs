...
namespace eShop.Controllers
{
    ...
    public class MasterBanksController : Controller
    {
        ...
        public PartialViewResult IndexGrid(string search)
        {
            ...
            {
                return PartialView("../Bank/MasterBanks/_IndexGrid", db.Set<MasterBank>().Where(x =>
        ...
        public ActionResult Create([Bind(Include = "Id,Code,Name,MasterRegionId,MasterBusinessUnitId,ChartOfAccountId,Type,OnBehalf,AccNumber,Notes,Active,Created,Updated,UserId")] MasterBank masterBank)
        {
            ...
            ViewBag.MasterBusinessUnitId = new SelectList(user.ApplicationUserMasterBusinessUnitRegions.Select(x => x.MasterBusinessUnit).Distinct(), "Id", "Name", masterBank.MasterBusinessUnitId);
