...
namespace eShop.Controllers
{
    public class PurchaseRequestsController : Controller
    {
        ...
        {
            return PartialView("../Buying/PurchaseRequests/_ViewGrid", db.PurchaseRequestsDetails
        ...
        public ActionResult Create([Bind(Include = "Id,Code,Date,MasterBusinessUnitId,MasterRegionId,MasterSupplierId,MasterWarehouseId,Notes,Active,Created,Updated,UserId")] PurchaseRequest purchaseRequest)
        {
            ...
            using (DbContextTransaction dbTran = db.Database.BeginTransaction())
            {
                ...
                ViewBag.MasterBusinessUnitId = new SelectList(user.ApplicationUserMasterBusinessUnitRegions.Select(x => x.MasterBusinessUnit).Distinct(), "Id", "Name", purchaseRequest.MasterBusinessUnitId);
