...
{
    [Authorize]
    public class CashBankOutsController : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: Invoices
        [Authorize(Roles = "CashBankOutsActive")]
        public ActionResult Index()
        {
            ViewBag.Resi = "";
            return View("../CashAndBank/CashBankOuts/Index");
        }
        ...
        public PartialViewResult IndexGrid(String search)
        {
            ...
            if (String.IsNullOrEmpty(search))
                return PartialView("../CashAndBank/CashBankOuts/_IndexGrid", db.Set<CashBankTransaction>().Where(x => x.TransactionType == EnumCashBankTransactionType.Out &&
        ...
        [Authorize(Roles = "CashBankOutsView")]
        public ActionResult Details(int? id)
        {
            ...
            return PartialView("../CashAndBank/CashBankOuts/_Details", cashBankTransaction);
        }

        // GET: Invoices/Create
        [Authorize(Roles = "CashBankOutsAdd")]
        public ActionResult Create()
        {
            ...
            using (DbContextTransaction dbTran = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    cashBankTransaction.TransactionType = EnumCashBankTransactionType.Out;
            ...
            return View("../CashAndBank/CashBankOuts/Create", cashBankTransaction);
        }
                ...
                using (DbContextTransaction dbTran = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (journal == null)
                        {
                            ...
                            {
                                SharedFunctions.CreateCashBankJournalDetails(cashBankTransactionDetails, journal, EnumCashBankTransactionType.Out, db);
                            }

                            foreach (CashBankTransactionDetailsHeader cashBankTransactionDetailsHeader in cashBankTransactionsDetailsHeader)
                            {
                                SharedFunctions.CreateCashBankJournalDetailsHeader(cashBankTransactionDetailsHeader, journal, EnumCashBankTransactionType.Out, db);
                            }
                        }
                        else
                            journal = SharedFunctions.UpdateCashBankJournal(journal, cashBankTransaction, EnumCashBankTransactionType.Out, db);

                        db.SystemLogs.Add(new SystemLog { Date = DateTime.Now, MenuType = EnumMenuType.BankOuts, MenuId = cashBankTransaction.Id, MenuCode = cashBankTransaction.Code, Actions = EnumActions.CREATE, UserId = User.Identity.GetUserId<int>() });
                        db.SaveChanges();
        ...
        // GET: Invoices/Edit/5
        [Authorize(Roles = "CashBankOutsEdit")]
        public ActionResult Edit(int? id)
        {
            ...
            if (cashBankTransaction.IsPrint)
            {
                ...
                return View("../CashAndBank/CashBankOuts/EditVerification", verificationHistory);
            }
            else
            {
                ApplicationUser user = db.Users.Find(User.Identity.GetUserId<int>());
                ...
                ViewBag.Total = SharedFunctions.GetTotalCashBankTransactionDetails(db, cashBankTransaction.Id).ToString("N2");
                ViewBag.TotalHeader = SharedFunctions.GetTotalCashBankTransactionDetailsHeader(db, cashBankTransaction.Id).ToString("N2");
                return View("../CashAndBank/CashBankOuts/Edit", cashBankTransaction);
            }
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "CashBankOutsPrint")]
            ...
            if (ModelState.IsValid)
            {
                ...
                using (DbContextTransaction dbTran = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        db.SystemLogs.Add(new SystemLog { Date = DateTime.Now, MenuType = EnumMenuType.BankOuts, MenuId = cashBankTransaction.Id, MenuCode = cashBankTransaction.Code, Actions = EnumActions.EDIT, UserId = User.Identity.GetUserId<int>() });
                        db.SaveChanges();
        ...
        public ActionResult Print(int? id)
        {
            ...
            if (obj.IsPrint)
            {
                ...
                return View("../CashAndBank/CashBankOuts/Print", verificationHistory);
            }
            else
            {
        ...
        public ActionResult GetVerificationCode(int? id)
        {
            ...
            return PartialView("../CashAndBank/CashBankOuts/_VerificationCode");
        }
        ...
        [HttpPost]
        [ValidateJsonAntiForgeryToken]
        [Authorize(Roles = "CashBankOutsDelete")]
        ...
        {
            return PartialView("../CashAndBank/CashBankOuts/_DetailsGrid", db.CashBankTransactionsDetails
        ...
        public ActionResult DetailsCreate(int? cashBankTransactionId)
        {
            ...
            return PartialView("../CashAndBank/CashBankOuts/_DetailsCreate", cashBankTransactioneDetails);
        }
        ...
        public ActionResult DetailsCreate([Bind(Include = "Id,CashBankTransactionId,Type,MasterCashBankId,ChartOfAccountId,Total,Notes,Created,Updated,UserId")] CashBankTransactionDetails cashBankTransactionDetails)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (DbContextTransaction dbTran = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        db.SystemLogs.Add(new SystemLog { Date = DateTime.Now, MenuType = EnumMenuType.BankOutsDetails, MenuId = cashBankTransactionDetails.Id, MenuCode = cashBankTransactionDetails.ChartOfAccountId.ToString(), Actions = EnumActions.CREATE, UserId = User.Identity.GetUserId<int>() });
                        db.SaveChanges();
            ...
            return PartialView("../CashAndBank/CashBankOuts/_DetailsCreate", cashBankTransactionDetails);
        }
        ...
        public ActionResult DetailsEdit(int? id)
        {
            ...
            return PartialView("../CashAndBank/CashBankOuts/_DetailsEdit", obj);
        }
        ...
        public ActionResult DetailsEdit([Bind(Include = "Id,CashBankTransactionId,Type,MasterCashBankId,ChartOfAccountId,Total,Notes,Created,Updated,UserId")] CashBankTransactionDetails cashBankTransactionDetails)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (DbContextTransaction dbTran = db.Database.BeginTransaction())
                {
                    try
                    {
                        SharedFunctions.UpdateCashBankJournalDetails(cashBankTransactionDetails, EnumCashBankTransactionType.Out, db);
                        ...
                        db.SystemLogs.Add(new SystemLog { Date = DateTime.Now, MenuType = EnumMenuType.BankOutsDetails, MenuId = cashBankTransactionDetails.Id, MenuCode = cashBankTransactionDetails.ChartOfAccountId.ToString(), Actions = EnumActions.EDIT, UserId = User.Identity.GetUserId<int>() });
                        db.SaveChanges();
            ...
            return PartialView("../CashAndBank/CashBankOuts/_DetailsEdit", cashBankTransactionDetails);
        }
        ...
        {
            return PartialView("../CashAndBank/CashBankOuts/_DetailsHeaderGrid", db.CashBankTransactionsDetailsHeader
                .Where(x => x.CashBankTransactionId == Id).ToList());
        }
        ...
        public ActionResult DetailsHeaderCreate(int? cashBankTransactionId)
        {
            ...
            return PartialView("../CashAndBank/CashBankOuts/_DetailsHeaderCreate", cashBankTransactioneDetailsHeader);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "CashBankOutsActive")]
        public ActionResult DetailsHeaderCreate([Bind(Include = "Id,CashBankTransactionId,Type,MasterCashBankId,GiroChequeId,DueDate,Voyage,Total,Notes,Created,Updated,UserId")] CashBankTransactionDetailsHeader cashBankTransactionDetailsHeader)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using (DbContextTransaction dbTran = db.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        db.SystemLogs.Add(new SystemLog { Date = DateTime.Now, MenuType = EnumMenuType.BankOutsDetails, MenuId = cashBankTransactionDetailsHeader.Id, MenuCode = cashBankTransactionDetailsHeader.MasterCashBankId.ToString(), Actions = EnumActions.CREATE, UserId = User.Identity.GetUserId<int>() });
                        db.SaveChanges();
            ...
            return PartialView("../CashAndBank/CashBankOuts/_DetailsCreate", cashBankTransactionDetailsHeader);
        }
        ...
        public ActionResult DetailsHeaderEdit(int? id)
        {
            ...
            return PartialView("../CashAndBank/CashBankOuts/_DetailsHeaderEdit", obj);
        }
        ...
        public ActionResult DetailsHeaderEdit([Bind(Include = "Id,CashBankTransactionId,Type,MasterCashBankId,GiroChequeId,Total,Notes,Created,Updated,UserId")] CashBankTransactionDetailsHeader cashBankTransactionDetailsHeader)
        {
            ...
            if (ModelState.IsValid)
            {
                using (DbContextTransaction dbTran = db.Database.BeginTransaction())
                {
                    ...
                    try
                    {
                        SharedFunctions.UpdateCashBankJournalDetailsHeader(cashBankTransactionDetailsHeader, EnumCashBankTransactionType.Out, db);
                        ...
                        db.SystemLogs.Add(new SystemLog { Date = DateTime.Now, MenuType = EnumMenuType.BankOutsDetails, MenuId = cashBankTransactionDetailsHeader.Id, MenuCode = cashBankTransactionDetailsHeader.MasterCashBankId.ToString(), Actions = EnumActions.EDIT, UserId = User.Identity.GetUserId<int>() });
                        db.SaveChanges();
            ...
            return PartialView("../CashAndBank/CashBankOuts/_DetailsEdit", cashBankTransactionDetailsHeader);
        }
                        ...
                        else
                        {
                            using (DbContextTransaction dbTran = db.Database.BeginTransaction())
                            {
                                try
                                {
                                    ...
                                    db.SystemLogs.Add(new SystemLog { Date = DateTime.Now, MenuType = EnumMenuType.BankOutsDetails, MenuId = tmp.Id, MenuCode = tmp.CashBankTransactionId.ToString(), Actions = EnumActions.DELETE, UserId = User.Identity.GetUserId<int>() });
                                    db.SaveChanges();
                                    dbTran.Commit();
                                }
                                catch (DbEntityValidationException ex)
