...
namespace eShop.Controllers
{
    ...
    public class ChequeOutsController : Controller
    {
        ...
        {
            return View("../CashAndBank/ChequeOuts/Index");
        }
        ...
        public PartialViewResult IndexGrid(String search)
        {
            if (String.IsNullOrEmpty(search))
                return PartialView("../CashAndBank/ChequeOuts/_IndexGrid", db.Set<Cheque>().Where(o => o.Type == EnumChequeType.ChequeOut).AsQueryable());
            else
                return PartialView("../CashAndBank/ChequeOuts/_IndexGrid", db.Set<Cheque>().Where(o => o.Type == EnumChequeType.ChequeOut).AsQueryable()
        ...
        public ActionResult Details(int? id)
        {
            ...
            return PartialView("../CashAndBank/ChequeOuts/_Details", Cheque);
        }
        ...
        public ActionResult Create()
        {
            ...
            return PartialView("../CashAndBank/ChequeOuts/_Create", obj);
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Code,Date,DueDate,Issued,MasterBusinessUnitId,Type,OnBehalf,AccNumber,Ammount,Notes,Active,Created,Updated,UserId")] Cheque ChequeOut)
        {
            ...
            return PartialView("../CashAndBank/ChequeOuts/_Create", ChequeOut);
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.MasterBusinessUnitId = new SelectList(db.MasterBusinessUnits.Where(x => x.Active == true), "Id", "Name", ChequeOut.MasterBusinessUnitId);
            return PartialView("../CashAndBank/ChequeOuts/_Edit", ChequeOut);
        }
