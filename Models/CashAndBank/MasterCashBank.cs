...
namespace eShop.Models
{
    ...
    public class MasterCashBank
    {
        ...
        [Remote("IsCodeExists", "MasterCashBanks", AdditionalFields = "Id", ErrorMessage = "Kode ini sudah dipakai.")]
    ...
    public class MasterCashBankDatalistViewModel
    {
        [Key]
        public int Id { get; set; }
    ...
    public class MasterCashBankRegionDatalist : MvcDatalist<MasterCashBankDatalistViewModel>
    {
        ...
        public override IQueryable<MasterCashBankDatalistViewModel> GetModels()
        {
            return Context.Set<MasterCashBank>()
                .Select(x => new MasterCashBankDatalistViewModel
                {
                    Id = x.Id,
                    Code = x.Code,
                    Name = x.Name,
