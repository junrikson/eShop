...
namespace eShop.Models
{
    public class SellingPrice
    {
        ...
        [Remote("IsCodeExists", "SellingPrices", AdditionalFields = "Id", ErrorMessage = "This code has been used.")]
    ...
    public class SellingPriceCustomer
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int Id { get; set; }
        ...
        [Required(ErrorMessage = "Selling Price harus diisi.")]
