...
namespace eShop.Models
{
    public class ShippingFee
    {
        ...
        [DatalistColumn]
        [Required(ErrorMessage = "Kode ShippingFee must be filled.")]
        [Index("IX_Code", Order = 1, IsUnique = true)]
        [Display(Name = "Kode Biaya Pengiriman")]
        [StringLength(128, ErrorMessage = "Maximum 128 Characters.")]
        [Remote("IsCodeExists", "ShippingFees", AdditionalFields = "Id", ErrorMessage = "This code has been used.")]
        public string Code { get; set; }

        [Display(Name = "Kota Tujuan")]
        [Required(ErrorMessage = "Kota Tujuan harus diisi.")]
    ...
    public class ShippingFeeCustomer
    {
        [Key]
        [DatabaseGenerated(DatabaseGeneratedOption.Identity)]
        public int Id { get; set; }

        [Display(Name = "ShippingFee")]
        [Required(ErrorMessage = "ShippingFee harus diisi.")]
